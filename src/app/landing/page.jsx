	...
	return (
		<div>
			<div className="container">
				...
				<div>
					<div>
						<p>¡Bienvenidos a <h3> The Fourth Element! </h3>  Durante 10</p>
						<p>semanas explorarás una plataforma educativa que</p>
						<p>fusiona <h3> teoría y práctica </h3> en un enfoque único.</p>
				...
				<img alt='' src='/undefined.png' />
				<div>
					<img alt='' src='/undefined1.png' />
					<div>Get started (free trial)</div>
				</div>
				<div>
					<img alt='' src='/undefined2.png' />
					<div>Grupos</div>
				</div>
				<div>
					<div>Take a tour</div>
